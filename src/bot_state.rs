...
impl fmt::Display for BotStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            BotStatus::InGame        => write!(f, "In Game"),
            BotStatus::TwoFactorAuth    => write!(f, "Two Factor Auth"),
            BotStatus::ServerOverloaded => write!(f, "Server Overloaded"),
            BotStatus::TooManyLogins    => write!(f, "Too Many Logins"),
            BotStatus::UpdateRequired   => write!(f, "Update Required"),
